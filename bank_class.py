...
class Bank(ABC):
    ...
    """
    ### YOUR CODE HERE
    # This class must derive from class ABC

    def basicinfo(self):
        print("This is a generic bank")
        return "Generic bank: 0"
    # Define a second function called withdraw and keep it empty by adding the `pass` keyword under it. Make this function abstract by adding an '@abstractmethod' tag right above the function declaration.
